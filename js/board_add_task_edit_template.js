  ...
  return /*html*/ `
            <label for="editCheckbox${i}">
                <li class="edit-contactlist" id="edit-contactlist${i}">        
                    ...
                    <div class="edit-contact-name" >${user.user.first_name} ${user.user.last_name}</div> 
                    <input class="edit-user-checkbox" onclick="showEditUsersEmblem(event)" type="checkbox" id="editCheckbox${i}" data-userid="${user.user.id}">          
                </li>
            </label> `;
}
...
function renderEditEmblemUsers(user) {
  return /*html*/ `
      <div class="edit-single-user">
          <div class="edit-emblem" style="background-color: ${user.color}" id="${user.user.id}">
            ${user.emblem}
          </div>
        </div>
      `;
